...
def _scan_empty_message(default="No .mp3/.m4a/.flac files in this folder."):
...
def _read_common_tags(fp):
    """Read title, artist, album_artist, album from .mp3/.m4a/.flac. Returns dict with empty strings on failure."""
...
def _embed_lyrics(fp, lyrics):
    """Embed lyrics string into mp3/m4a/flac file. Always prepends a 'TN' marker as
